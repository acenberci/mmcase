...
export default function MainContent() {
  return (
    <div id="mainContent" className="transition-all ease-in-out duration-1000 w-[calc(100vw-270px)] ml-[270px] h-[100vh] bg-mainBackground flex flex-col max-lg:ml-[0px] max-lg:w-[100vw]">
      <header className=' py-[5px] px-[25px] box-border border-b-[1px] border-solid border-b-[rgb(230,230,230)] flex justify-between bg-white items-center'>
        ...
        <div className='flex h-[54px] items-center'>
          <button className="p-[15px] hover:scale-[110%] max-[500px]:hidden">
            <img src="/icons/content/application.png" alt="" className='size-[24px]' />
          </button>
          <div className=' h-full py-[12px] px-[6px] max-[500px]:hidden'>
          ...
          <button className="p-[15px] relative hover:scale-[110%] max-[500px]:hidden">
          ...
          <div className='px-[10px] flex items-center'>
            <div className='flex size-[34px] rounded-full bg-mainBlue text-white font-[600] text-[14px] justify-center items-center max-sm:mr-4'>ÖU</div>
      ...
      <div className='flex justify-between items-center px-[25px] max-[500px]:flex-col max-[500px]:items-center max-[500px]:pt-[20px]'>
        <div className='flex items-center gap-[10px] max-[500px]:justify-center'>
          <img src="/icons/content/invoicesContent.png" alt="" className='size-[50px]' />
          <div className='flex flex-col max-[500px]:self-center'>
        ...
        <div className='flex py-[30px] gap-[10px] max-[500px]:self-end max-[500px]:w-full max-[500px]:justify-end'>
          <button className='py-[7px] px-[8px] rounded-[6px] border-[1px] border-solid border-[rgb(12,132,9)] bg-[rgb(17,140,14)] hover:bg-[rgb(12,132,9)] hover:shadow-sm hover:shadow-[rgb(12,132,9)] h-[38px] font-[600] text-[15px] text-white flex'>
            <img src="/icons/content/add.png" alt="" className='size-[24px] mr-[6px]' /> Create Invoice
          </button>
      ...
      <div className=' px-[25px] pb-[25px] h-full flex flex-col'>
        <div className='bg-white rounded-md border-[1px] overflow-hidden h-full flex flex-col'>
          <div className='px-[15px] h-[60px]  border-b-[1px]'>
            <div className='flex gap-[20px] items-center font-[600] text-[15px] text-[rgba(41,41,41,0.8)] h-full'>
              ...
              <button className='size-[24px] rotate-90 h-full hover:scale-[110%] max-[400px]:hidden'><img src="/icons/content/more.png" alt="" /></button>
            </div>
          </div>
          <div className='px-[15px] py-[10px] border-x-[1px] border-b-[1px] flex max-lg:flex-col gap-[8px] justify-between max-[500px]:items-center bg-[rgb(246,249,252)]'>
            <div className='py-[10px] flex gap-[8px]'>
              <button className=' px-[14px] border-[1px] py-[3px] min-h-[27px] h-full rounded-full bg-white hover:bg-[rgb(205,205,205)] hover:shadow-sm flex items-center gap-[6px]'>
                <img src="/icons/content/setting.png" alt="" className=' size-[14px]' />
                <p className='font-[500] text-[14px] max-[400px]:hidden'>Filter</p>
                <div className=' bg-red-500 text-white rounded-full justify-center items-center flex size-[14px] min-w-[14px] min-h-[14px]'><p className='font-[600] text-[10px]'>3</p></div>
              </button>
              <button className=' px-[14px] border-[1px] py-[3px] border-transparent rounded-full min-h-[27px]  h-full text-ellipsis bg-mainBlue hover:bg-hoverMainBlue hover:shadow-sm hover:shadow-hoverMainBlue flex items-center gap-[6px] group'>
                <p className='font-[500] text-[14px] text-white text-ellipsis min-w-[120px]'>MT Vessel Name</p>
              ...
              <button className=' px-[14px] border-[1px] py-[3px] rounded-full bg-white  items-center gap-[6px] h-full hover:bg-[rgb(205,205,205)] hover:shadow-sm group hidden max-sm:flex  max-[500px]:hidden'>
                <p className='font-[500] text-[14px]'>Sort</p>
                <img src="/icons/content/sort.png" alt="" className=' min-[400px]:hidden size-[14px]' />
                <img src="/icons/content/arrowDown.png" alt="" className=' size-[14px]  transition-transform duration-100 ease-in-out group-hover:translate-y-[1px] group-hover:scale-[110%]' />
              </button>
            </div>
          ...
          <div className='h-full w-full overflow-x-auto '>
            <table class="min-w-[768px] w-full bg-white border border-gray-200 m-0 border-t-0">
          ...
          <div className='border py-[15px] pl-[20px] pr-[15px] flex justify-between max-sm:flex-col max-sm:gap-[10px] mt-auto items-center'>
